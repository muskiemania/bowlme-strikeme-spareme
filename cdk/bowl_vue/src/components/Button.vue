...
<template>
    <div class='draw-button' v-on:click="$emit('click')">
        <a href='#' class='button'>
...
.draw-button {
    ...
    .button {
        ...
        padding-left: 40px;
        padding-right: 40px;
        box-shadow: 0 4px 8px rgba(0,0,0,0.6), 0 6px 20px 0 rbga(0,0,0,0.6);
        border-radius: 5px;
    }
}

.draw-button.disabled .button {
    background: radial-gradient(#e0e0e0, #c0c0c0);
    color: #a0a0a0;
