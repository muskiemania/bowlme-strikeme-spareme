...
.poker-table {
    ...
    background: -webkit-radial-gradient(#00ff00, green);
    background: -o-radial-gradient(#00ff00, green);
    background: -moz-radial-gradient(#00ff00, green);
    background: radial-gradient(#00ff00, green);
}
