...
class Test_FullHouse():
    ...
    def test_isMatch_fullHouse_1(self):
        ...
        fullHouse = FullHouse()
        assert fullHouse.IsMatch(hand) == True
    ...
    def test_isMatch_notFourOfAKind(self):
        ...
        fullHouse = FullHouse()
        assert fullHouse.IsMatch(hand) == False
    ...
    def test_getRating_high(self):
        ...
        fullHouse = FullHouse()
        assert fullHouse.GetRating(hand) == (7, 2, 11, 99, 99, 99)

    def test_getRating_low(self):
        hand = Hand([Card('2S'),Card('2H'),Card('JD'),Card('JH'),Card('JS')])
        fullHouse = FullHouse()
        assert fullHouse.GetRating(hand) == (7, 11, 2, 99, 99, 99)
